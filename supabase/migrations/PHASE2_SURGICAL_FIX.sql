-- ============================================================================
-- PHASE 2 SURGICAL FIX - Only fix the 4 Phase 2 tables
-- ============================================================================
-- This leaves all your other tables intact (Phase 1 + social media tables)
-- Only recreates: constituencies, wards, polling_booths, voters
-- ============================================================================

-- Drop only the 4 Phase 2 tables we're creating (leave everything else alone)
...
SELECT 'Geography & territory tables created!' as note;
