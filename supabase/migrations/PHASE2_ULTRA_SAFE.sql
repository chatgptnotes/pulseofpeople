-- ============================================================================
-- PHASE 2 ULTRA SAFE MIGRATION - Explicitly drops everything step by step
-- ============================================================================

-- Step 1: Drop triggers safely
DO $$
BEGIN
...
-- Step 3: Explicitly drop all indexes
DROP INDEX IF EXISTS idx_voters_org CASCADE;
DROP INDEX IF EXISTS idx_voters_booth CASCADE;
DROP INDEX IF EXISTS idx_voters_sentiment CASCADE;
DROP INDEX IF EXISTS idx_voters_category CASCADE;
DROP INDEX IF EXISTS idx_voters_family CASCADE;
DROP INDEX IF EXISTS idx_voters_name CASCADE;
DROP INDEX IF EXISTS idx_voters_epic CASCADE;
DROP INDEX IF EXISTS idx_voters_phone CASCADE;
DROP INDEX IF EXISTS idx_voters_tags CASCADE;
DROP INDEX IF EXISTS idx_voters_issues CASCADE;

DROP INDEX IF EXISTS idx_booths_constituency CASCADE;
DROP INDEX IF EXISTS idx_booths_ward CASCADE;
DROP INDEX IF EXISTS idx_booths_org CASCADE;
DROP INDEX IF EXISTS idx_booths_location CASCADE;
DROP INDEX IF EXISTS idx_booths_active CASCADE;
DROP INDEX IF EXISTS idx_booths_priority CASCADE;

DROP INDEX IF EXISTS idx_wards_constituency CASCADE;
DROP INDEX IF EXISTS idx_wards_org CASCADE;
DROP INDEX IF EXISTS idx_wards_geom CASCADE;

DROP INDEX IF EXISTS idx_constituencies_org CASCADE;
DROP INDEX IF EXISTS idx_constituencies_state CASCADE;
DROP INDEX IF EXISTS idx_constituencies_type CASCADE;
DROP INDEX IF EXISTS idx_constituencies_geom CASCADE;
