    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6 md:mb-8 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div className="flex-1">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">{districtName} District Dashboard</h1>
        ...
        <div className="flex-shrink-0">
          <ExportButton
            data={constituencies}
            filename={`district-${districtName}-${format(new Date(), 'yyyy-MM-dd')}`}
            formats={['csv', 'excel']}
          />
        </div>
      </div>
      ...
      {/* Constituency Sentiment Trends Chart */}
      <div className="mb-6 md:mb-8">
        <LineChart
          data={Array.from({ length: 7 }, (_, i) => ({
            day: format(subDays(new Date(), 6 - i), 'MMM dd'),
            sentiment: Math.floor(60 + Math.random() * 15),
          }))}
          xKey="day"
          yKey="sentiment"
          title="District Sentiment Trend (Last 7 Days)"
          color="#8b5cf6"
          height={300}
        />
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6 mb-6 md:mb-8">
        <h2 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Constituencies Performance</h2>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
        <h2 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Recent Feedback from District</h2>
